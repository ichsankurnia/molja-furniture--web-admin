            ...
            <div className="modal-form">
                ...
                <div className="w-11/12 md:w-3/5 rounded-lg shadow bg-gray-700 z-50 overflow-y-auto" style={{ maxHeight: '90vh' }}>
                    ...
                    <form onSubmit={onSubmitForm} className="px-6 pb-4 space-y-5 lg:px-8 sm:pb-6 xl:pb-8">
                        <h3 className="text-xl font-medium text-white pb-4">{Object.keys(data).length > 0? "Form Update Product" : "Form Create Product"}</h3>
                        ...
                        <div className="md:flex md:space-x-10 space-y-5 md:space-y-0">
                            <div className="w-full">
                                ...
                                <input type="text" defaultValue={data?.dimention} id="dimention" name='dimention' className="input-form" placeholder="Dimention" />
                            </div>
                            <div className="w-full">
                        ...
                        <div className="md:flex md:space-x-10 space-y-5 md:space-y-0">
                            ...
                            <div className="w-full">
                                ...
                                <select id="category_id" name='category_id' className="input-form" defaultValue={data?.category_id} required>
