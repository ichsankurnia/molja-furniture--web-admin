...
const ConfirmModal: React.FC<Props> = ({ message, onClose, onNext }: Props) => {
	return <>
		<div className="modal-form">
			...
			{/* <!-- Modal content --> */}
			<div className="w-11/12 md:w-5/12 rounded-lg shadow bg-gray-700 z-50">
				{/* <!-- Modal header --> */}
				...
				<div className="p-6 pt-0 text-center">
					<svg className="mx-auto mb-4 w-14 h-14 text-gray-200" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
