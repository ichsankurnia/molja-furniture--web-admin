    ...
    return (
        <>
            <div className="modal-form">
                ...
                {/* <!-- Modal content --> */}
                <div className="w-11/12 md:w-8/12 text-white rounded-lg shadow bg-gray-700 z-50 overflow-y-auto" style={{ maxHeight: '90vh' }}>
                    ...
                    <div className="flex justify-between items-start p-5 rounded-t border-b border-gray-600">
                        ...
                        <button type="button" className="text-gray-400 bg-transparent rounded-lg text-sm p-1.5 ml-auto inline-flex items-center hover:bg-gray-600 hover:text-white"
                            onClick={onClose}
                        >
